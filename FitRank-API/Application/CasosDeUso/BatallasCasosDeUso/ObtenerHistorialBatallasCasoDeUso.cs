...
{
    public class ObtenerHistorialBatallasCasoDeUso
    {
        private readonly FitRankDbContext _context;

        public ObtenerHistorialBatallasCasoDeUso(FitRankDbContext context)
        {
            _context = context;
        }

        public virtual async Task<List<HistorialBatallaDTO>> Ejecutar(long socioId)
        {
