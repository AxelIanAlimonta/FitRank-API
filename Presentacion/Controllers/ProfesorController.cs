...
namespace FitRank_API.Presentacion.Controllers
{
    ...
    public class ProfesorController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> ActualizarAsync([FromBody] ActualizarProfesorDTO profesorDTO)
        {
            var profesorActualizado = await _actualizarProfesorCasoDeUso.Ejecutar(profesorDTO);
